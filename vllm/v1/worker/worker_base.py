...
class WorkerWrapperBase:
    ...
    def initialize_from_config(self, kv_cache_configs: list[Any]) -> None:
        ...
        # KV cache configs for its OWN workers only, so the list is indexed
        # by the instance-local worker index.  Legacy mode keeps the
        # world-sized list indexed by global rank.
